...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  produse set productImage1='$productimage1' where id='$pid' ");
...
<head>
	...
	<title>Adminnistrator| Actualizează imagine produs</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizează imagine produs1</h3>
							</div>
...
$query=mysqli_query($con,"select productName,productImage1 from produse where id='$pid'");
$cnt=1;
