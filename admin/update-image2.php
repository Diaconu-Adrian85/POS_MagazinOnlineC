...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  produse set productImage2='$productimage2' where id='$pid' ");
...
<head>
	...
	<title>Adminnistrator| Actualizeaza imagine produs</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizează imagine produs2</h3>
							</div>
...
$query=mysqli_query($con,"select productName,productImage2 from produse where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Denumire imagine produs1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Denumire imagine produs2</label>
<div class="controls">
