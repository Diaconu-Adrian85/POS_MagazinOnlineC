...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update  produse set productImage3='$productimage3' where id='$pid' ");
$_SESSION['msg']="Imagine produs actualizată cu succes !!";
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizează imagine produs3</h3>
							</div>
...
$query=mysqli_query($con,"select productName,productImage3 from produse where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Denumire imagine produs3</label>
<div class="controls">
