...
<head>
	...
	<title>Administrator | Administrează utilizatori</title>
...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3>Administrează utilizator</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									<thead>
										<tr>
											...
											<th>Email </th>
											<th>Număr contact</th>
											<th>Adresă livrare/Oraș/Județ/Cod poștal </th>
											<th>Adresă facturare/Oraș/Județ/Cod poștal</th>
...
<?php $query=mysqli_query($con,"select * from utilizatori");
$cnt=1;
